...
int main(int argc, char **argv)
{
    ...
    while (it--)
    {
        ...
        {
            MPI_Send(buffer, data_size, MPI_FLOAT, rank + 1, 0, MPI_COMM_WORLD);
            MPI_Recv(rn_buffer, rn_data_size, MPI_FLOAT, rank + 1, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        ...
        {
            MPI_Send(buffer, data_size, MPI_FLOAT, rank - 1, 0, MPI_COMM_WORLD);
            MPI_Recv(ln_buffer, ln_data_size, MPI_FLOAT, rank - 1, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
