...
```
## Experiment & Analysis
以下測試都是在本課程提供的Apollo platform，以及用NVIDIA Nsight System 做 performance analysis。

1. 測試程式主要花時間執行的任務 : 想要去了解本次odd-even-sort的程式主要花在computation time, communication time or I/O time。
![Main time test(rank_0)](https://hackmd.io/_uploads/SyvDvBRxkx.png)
